...
- __jupiter__: Reads a live market data stream and transmit to other components
  in janus while storing the data for future analysis.
- __neptune__: Converts existing market data to a binary file format for
  efficient analysis by other tools in janus.
